...
import BuyNow from './items/BuyNow';
import TopPics from './items/TopPics';
  ...
  return (
    <View>
      ...
      <ScrollView
        ...
        <BuyNow handleBuyNow={handleBuyNow} />
        <View>
          <Text style={styles.heading}>Pick up from where you left</Text>
        </View>
        <RecentView />
        <View>
        ...
        <View>
          <Text style={styles.heading}>Discount for you</Text>
          <RecentView />
        </View>
        <View>
